                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#men">Thời trang </a></li>
                            <li class="scroll-to-section"><a href="#women">Đồ điện tử</a></li>
                            <li class="scroll-to-section"><a href="#kids">Đồ gia dụng</a></li>
                            {{-- <li class="submenu">
